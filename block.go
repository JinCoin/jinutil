...
// Block defines a jincoin block that provides easier and more efficient
...
// Tx returns a wrapped transaction (jinutil.Tx) for the transaction at the
...
// Transactions returns a slice of wrapped transactions (jinutil.Tx) for all
...
// instead provides easy access to wrapped versions (jinutil.Tx) of them.
...
// NewBlock returns a new instance of a jincoin block given an underlying
...
// NewBlockFromBytes returns a new instance of a jincoin block given the
...
// NewBlockFromReader returns a new instance of a jincoin block given a
...
// NewBlockFromBlockAndBytes returns a new instance of a jincoin block given
