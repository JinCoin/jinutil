...
import (
	...
	"github.com/JinCoin/jinutil/coinset"
)

type TestCoin struct {
	TxHash     *chainhash.Hash
	TxIndex    uint32
	TxValue    jinutil.Amount
	TxNumConfs int64
}

func (c *TestCoin) Hash() *chainhash.Hash { return c.TxHash }
func (c *TestCoin) Index() uint32         { return c.TxIndex }
func (c *TestCoin) Value() jinutil.Amount { return c.TxValue }
...
func NewCoin(index int64, value jinutil.Amount, numConfs int64) coinset.Coin {
	h := sha256.New()
...
var (
	...
	testSimpleCoinTxValue0            = jinutil.Amount(3500000)
	...
	testSimpleCoinTx, _               = jinutil.NewTxFromBytes(testSimpleCoinTxBytes)
