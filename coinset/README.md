...
(http://godoc.org/github.com/JinCoin/jinutil/coinset)

Package coinset provides jincoin-specific convenience functions for selecting
...
```bash
$ go get -u github.com/JinCoin/jinutil/coinset
```
...
The typical use case for this library is for creating raw jincoin transactions
